...
```{r echo = FALSE}
premier_de_l_an <- rep(0, 7)
names(premier_de_l_an) <- c("Dimanche", "Lundi", "Mardi", "Mercredi", "Jeudi", "Vendredi", "Samedi")

jour = 6 # samedi en l'an 2000
for (year in 0:(400 * 1 - 1)) {
    premier_de_l_an[jour + 1] <- premier_de_l_an[jour + 1] + 1
    if (year %% 400 == 0) {
        jour <- jour + 366
    } else if (year %% 100 == 0) {
        jour <- jour + 365
